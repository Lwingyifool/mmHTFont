 ...
 */
public final class HTFTypefaceUtils {

    private static final Map<String, Typeface> sCachedFonts = new HashMap<String, Typeface>();
    private static final Map<Typeface, HTFTypefaceSpan> sCachedSpans = new HashMap<Typeface, HTFTypefaceSpan>();
     ...
     */
    public static HTFTypefaceSpan getSpan(final Typeface typeface) {
        if (typeface == null) return null;
        synchronized (sCachedSpans) {
            if (!sCachedSpans.containsKey(typeface)) {
                final HTFTypefaceSpan span = new HTFTypefaceSpan(typeface);
