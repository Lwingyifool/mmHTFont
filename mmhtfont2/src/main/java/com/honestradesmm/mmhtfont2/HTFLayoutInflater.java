 ...
 * Project: Calligraphy
 */
class HTFLayoutInflater extends LayoutInflater implements HTFActivityFactory {
    ...
    private final HTFFactory mHTFFactory;
    // Reflection Hax
    private boolean mSetPrivateFactory = false;
    private Field mConstructorArgs = null;

    protected HTFLayoutInflater(Context context, int attributeId) {
        super(context);
        mAttributeId = attributeId;
        mHTFFactory = new HTFFactory(attributeId);
        setUpLayoutFactories(false);
    }

    protected HTFLayoutInflater(LayoutInflater original, Context newContext, int attributeId, final boolean cloned) {
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new HTFLayoutInflater(this, newContext, mAttributeId, true);
    }
    ...
    public void setFactory(Factory factory) {
        ...
        if (!(factory instanceof WrapperFactory)) {
            super.setFactory(new WrapperFactory(factory, this, mHTFFactory));
        } else {
...
//            LayoutInflaterCompat.setFactory(this, new WrapperFactory2(factory2, mHTFFactory));
            super.setFactory2(new WrapperFactory2(factory2, mHTFFactory));
        } else {
    ...
    private void setPrivateFactoryInternal() {
        ...
        if (!HTFConfig.get().isReflection()) return;
        ...
        final Method setPrivateFactoryMethod = HTFReflectionUtils
                .getMethod(LayoutInflater.class, "setPrivateFactory");

        if (setPrivateFactoryMethod != null) {
            HTFReflectionUtils.invokeMethod(this,
                    setPrivateFactoryMethod,
                    new PrivateWrapperFactory2((Factory2) getContext(), this, mHTFFactory));
        }
        mSetPrivateFactory = true;
    }
    ...
    public View onActivityCreateView(View parent, View view, String name, Context context, AttributeSet attrs) {
        return mHTFFactory.onViewCreated(createCustomViewInternal(parent, view, name, context, attrs), context, attrs);
    }
    ...
    protected View onCreateView(View parent, String name, AttributeSet attrs) throws ClassNotFoundException {
        return mHTFFactory.onViewCreated(super.onCreateView(parent, name, attrs),
                getContext(), attrs);
    }
    ...
    protected View onCreateView(String name, AttributeSet attrs) throws ClassNotFoundException {
        ...
        return mHTFFactory.onViewCreated(view, view.getContext(), attrs);
    }
    ...
    private View createCustomViewInternal(View parent, View view, String name, Context viewContext, AttributeSet attrs) {
        ...
        if (!HTFConfig.get().isCustomViewCreation()) return view;
        if (view == null && name.indexOf('.') > -1) {
            if (mConstructorArgs == null)
                mConstructorArgs = HTFReflectionUtils.getField(LayoutInflater.class, "mConstructorArgs");

            final Object[] mConstructorArgsArr = (Object[]) HTFReflectionUtils.getValue(mConstructorArgs, this);
            ...
            HTFReflectionUtils.setValue(mConstructorArgs, this, mConstructorArgsArr);
            try {
    ...
    private static class WrapperFactory implements Factory {
        ...
        private final HTFLayoutInflater mInflater;
        private final HTFFactory mHTFFactory;

        public WrapperFactory(Factory factory, HTFLayoutInflater inflater, HTFFactory HTFFactory) {
            mFactory = factory;
            mInflater = inflater;
            mHTFFactory = HTFFactory;
        }

        @Override
        public View onCreateView(String name, Context context, AttributeSet attrs) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) {
                return mHTFFactory.onViewCreated(
    ...
    private static class WrapperFactory2 implements Factory2 {
        ...
        protected final HTFFactory mHTFFactory;

        public WrapperFactory2(Factory2 factory2, HTFFactory HTFFactory) {
            mFactory2 = factory2;
            mHTFFactory = HTFFactory;
        }
    ...
    private static class PrivateWrapperFactory2 extends WrapperFactory2 {
        ...
        public PrivateWrapperFactory2(Factory2 factory2, HTFLayoutInflater inflater, HTFFactory HTFFactory) {
            super(factory2, HTFFactory);
            mInflater = inflater;
        }
